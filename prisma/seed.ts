...
async function main() {
    ...
    await (prisma as any).interactionTypeConfig.deleteMany();

    console.log('✅ Dados antigos removidos');

    // Criar tipos de interação padrão
    const interactionTypes = [
        ...
        { name: "Amostra", emoji: "🧪", isSaleType: false, isSystem: true, color: "teal", order: 6 },
        { name: "Venda Balcão", emoji: "🏪", isSaleType: true, isSystem: true, color: "emerald", order: 7 },
    ];

    for (const itc of interactionTypes) {
        await (prisma as any).interactionTypeConfig.create({ data: itc });
    }

    console.log('✅ Tipos de interação criados');
    ...
    console.log('  Gestor: admin@gp.com / 123456');
    console.log('  Vendedor 1: joao@gp.com / 123456');
    console.log('  Vendedor 2: maria@gp.com / 123456');
}
