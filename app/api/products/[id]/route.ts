    ...
    try {
        ...
        const product = await prisma.product.update({
            ...
            data: {
                ...
                ...(validatedData.stockQuantity !== undefined && { stockQuantity: validatedData.stockQuantity ?? 0 }),
                ...(validatedData.minStockLevel !== undefined && { minStockLevel: validatedData.minStockLevel ?? 0 }),
                ...(validatedData.unit !== undefined && { unit: validatedData.unit ?? "UN" }),
            },
        });
