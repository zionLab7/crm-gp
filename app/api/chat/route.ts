...
const SYSTEM_PROMPT = `Você é o Assistente IA da GP Distribuidora, um analista de negócios experiente e estratégico.
        ...
        const chat = model.startChat({
            history: [
                ...
                },
                {
                    ...
                    parts: [
                        {
                            text: "Entendido! Analisei todos os dados da GP Distribuidora. Estou pronto para responder suas perguntas sobre vendedores, clientes, pipeline, tarefas e produtos. Como posso ajudar?",
                        },
                    ],
                },
