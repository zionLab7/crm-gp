...
const navigation = [
    ...
    { name: "Balcão", href: "/pos", icon: ShoppingCart },
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="md:hidden fixed top-0 left-0 right-0 z-40 h-14 bg-white border-b border-gray-200 flex items-center px-4">
                ...
                <div className="flex items-center gap-2 ml-2">
                    <div className="w-7 h-7 bg-gradient-gp rounded-lg flex items-center justify-center">
                        <svg
                    ...
                    <span className="text-lg font-bold">GP CRM</span>
                </div>
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200">
                    <div className="flex items-center">
                        <div className="w-8 h-8 bg-gradient-gp rounded-lg flex items-center justify-center">
                            <svg
                        ...
                        <span className="ml-3 text-xl font-bold">GP CRM</span>
                    </div>
                ...
                <div className="p-4 border-t border-gray-200">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="w-10 h-10 bg-gradient-gp rounded-full flex items-center justify-center text-white font-semibold">
