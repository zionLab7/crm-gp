                ...
                <Card className="sticky top-6">
                    <CardContent className="p-6">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 bg-gradient-gp rounded-full flex items-center justify-center text-white text-sm font-semibold">
                                ...
                                <Card key={interaction.id} className="hover:shadow-md transition-shadow">
                                    <CardContent className="p-4">
                                        <div className="flex gap-3">
                                            {/* Avatar do Vendedor */}
                                            <div className="w-10 h-10 bg-gradient-gp rounded-full flex items-center justify-center text-white text-sm font-semibold flex-shrink-0">
